...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.ColorPicker(config)
            ...
            local HueSlider = Linux.Instance("Frame", {
                Parent = ColorPicker,
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                Size = UDim2.new(1, -10, 0, 6),
            ...
            local ColorPreview = Linux.Instance("Frame", {
                ...
                Position = UDim2.new(0.5, -15, 0, 100),
                ZIndex = 1
            })
            ...
            HueSlider.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    local relativeX = math.clamp((posX - HueSlider.AbsolutePosition.X) / hueSize, 0, 1)
                    Hue = relativeX
                    HueKnob.Position = UDim2.new(relativeX, -6, 0, -3)
                    UpdateColor()
                end
            end)
            ...
            local function SetColor(newColor)
                ...
                Saturation = s
                Value = v
                HueKnob.Position = UDim2.new(Hue, -6, 0, -3)
