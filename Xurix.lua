...
local Linux = {
    Theme = {
        ...
        SecondaryBorder = Color3.fromRGB(80, 80, 80)
    }
}
...
function Linux:ApplyBorder(element)
    local border = Linux.Instance("UIStroke", {
        Parent = element,
        Color = Linux.Theme.Border,
        Thickness = 1,
        Transparency = 0.3,
...
function Linux:ApplySecondaryBorder(element)
    local secondaryBorder = Linux.Instance("UIStroke", {
        Parent = element,
        Color = Linux.Theme.SecondaryBorder,
        Thickness = 2,
        Transparency = 0.5,
        ApplyStrokeMode = Enum.ApplyStrokeMode.Border
    })
...
function Linux:Notify(config)
    ...
    Linux:ApplyBorder(Notification)
    Linux:ApplySecondaryBorder(Notification)
...
function Linux.Create(config)
    ...
    Linux:ApplyBorder(Main)
    Linux:ApplySecondaryBorder(Main)
    ...
    Linux:ApplyBorder(TopBar)
    Linux:ApplySecondaryBorder(TopBar)
    ...
    function LinuxLib.Tab(config)
        ...
        Linux:ApplyBorder(TabBtn)
        Linux:ApplySecondaryBorder(TabBtn)
        ...
        function TabElements.Button(config)
            ...
            Linux:ApplyBorder(BtnFrame)
            Linux:ApplySecondaryBorder(BtnFrame)
        ...
        function TabElements.Toggle(config)
            ...
            Linux:ApplyBorder(Toggle)
            Linux:ApplySecondaryBorder(Toggle)
            ...
            Linux:ApplyBorder(ToggleBox)
            Linux:ApplySecondaryBorder(ToggleBox)
            ...
            local KnobBorder = Linux:ApplyBorder(Knob)
            local KnobSecondaryBorder = Linux:ApplySecondaryBorder(Knob)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(Knob, tween, {Position = UDim2.new(1, -22, 0, 2), BackgroundColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                    KnobBorder.Enabled = false
                    KnobSecondaryBorder.Enabled = false
                else
                    ...
                    KnobBorder.Enabled = true
                    KnobSecondaryBorder.Enabled = true
                end
            end
        ...
        function TabElements.Dropdown(config)
            ...
            Linux:ApplyBorder(Dropdown)
            Linux:ApplySecondaryBorder(Dropdown)
            ...
            local DropFrameCorner = Linux.Instance("UICorner", {
                Parent = DropFrame,
                CornerRadius = UDim.new(0, 8)
            })

            local DropFrameBorder = Linux:ApplyBorder(DropFrame)
            local DropFrameSecondaryBorder = Linux:ApplySecondaryBorder(DropFrame)
            ...
            local function UpdateDropSize()
                ...
                local calculatedHeight = numOptions * optionHeight + (numOptions - 1) * paddingBetween + paddingTop + paddingBottom
            ...
            local function PopulateOptions()
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        ...
                        Linux:ApplyBorder(OptBtn)
                        Linux:ApplySecondaryBorder(OptBtn)
        ...
        function TabElements.MultiDropdown(config)
            ...
            Linux:ApplyBorder(MultiDropdown)
            Linux:ApplySecondaryBorder(MultiDropdown)
        ...
        function TabElements.Slider(config)
            ...
            Linux:ApplyBorder(Slider)
            Linux:ApplySecondaryBorder(Slider)
            ...
            Linux:ApplyBorder(SliderBar)
            Linux:ApplySecondaryBorder(SliderBar)
            ...
            Linux:ApplyBorder(Knob)
            Linux:ApplySecondaryBorder(Knob)
            ...
            local function UpdateSlider(pos)
                ...
                Knob.Position = UDim2.new(relativePos, -8, 0, -4)
        ...
        function TabElements.Input(config)
            ...
            Linux:ApplyBorder(Input)
            Linux:ApplySecondaryBorder(Input)
            ...
            Linux:ApplyBorder(TextBox)
            Linux:ApplySecondaryBorder(TextBox)
        ...
        function TabElements.Label(config)
            ...
            Linux:ApplyBorder(LabelFrame)
            Linux:ApplySecondaryBorder(LabelFrame)
        ...
        function TabElements.Keybind(config)
            ...
            Linux:ApplyBorder(Keybind)
            Linux:ApplySecondaryBorder(Keybind)
            ...
            Linux:ApplyBorder(KeyBox)
            Linux:ApplySecondaryBorder(KeyBox)
        ...
        function TabElements.ColorPicker(config)
            ...
            Linux:ApplyBorder(ColorPicker)
            Linux:ApplySecondaryBorder(ColorPicker)
            ...
            Linux:ApplyBorder(ColorPreview)
            Linux:ApplySecondaryBorder(ColorPreview)
            ...
            Linux:ApplyBorder(Palette)
            Linux:ApplySecondaryBorder(Palette)
            ...
            Linux:ApplyBorder(PaletteKnob)
            Linux:ApplySecondaryBorder(PaletteKnob)
            ...
            Palette.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    Value = 1 - relativeY
                    PaletteKnob.Position = UDim2.new(relativeX, -6, relativeY, -6)
                    UpdateColor()
                end
            end)
            ...
            local function SetColor(newColor)
                ...
                Saturation = s
                Value = v
                PaletteKnob.Position = UDim2.new(Saturation, -6, 1 - Value, -6)
                UpdateColor()
            end
        ...
        function TabElements.Paragraph(config)
            ...
            Linux:ApplyBorder(ParagraphFrame)
            Linux:ApplySecondaryBorder(ParagraphFrame)
        ...
        function TabElements.Notification(config)
            ...
            Linux:ApplyBorder(NotificationFrame)
            Linux:ApplySecondaryBorder(NotificationFrame)
