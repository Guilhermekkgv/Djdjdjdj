...
local Linux = {
    Theme = {
        ...
        TabInactive = Color3.fromRGB(7, 7, 7),
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(ToggleFill, tween, {BackgroundColor3 = Linux.Theme.Element, Size = UDim2.new(0, 0, 1, 0)}):Play()
        ...
        function TabElements.Slider(config)
            ...
            local function UpdateSlider(pos)
                ...
                Knob.Position = UDim2.new(relativePos, -8, 0, -3),
